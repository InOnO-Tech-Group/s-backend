...
import { isSameService, isServiceExistById, isServicesExist } from "../middlewares/serviceMiddleware.js";
...
serviceRoute.get("/view",isUserAuthorized,isServicesExist,serviceController.getAllServices)
serviceRoute.get("/view/:serviceId",isUserAuthorized,isServiceExistById,serviceController.getSingleServiceById)
